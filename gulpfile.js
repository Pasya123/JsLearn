...
gulp.task('sass', function(){
    return gulp.src('app/scss/**/*.scss') 
        .pipe(sass({outputStyle: 'expanded'})) // меняет стиль sass (при вложенности и т.п.) на классический стиль цсс (можно изменить на compressed и раскомментировать строку ниже, тогда файл сожмётся и переименуется)
